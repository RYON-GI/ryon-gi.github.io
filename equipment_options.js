...
export const ITEM_OPTIONS = {
  ...
  "개척자 섬유 장갑": {
    ...
    uniqueStat: { name: "모든 스킬 피해 보너스", value: "+23%" },
    forge: [
      { name: "의지", lv1: 71, lv2: 78, lv3: 84 },
      { name: "힘", lv1: 47, lv2: 51, lv3: 55 },
      { name: "모든 스킬 피해 보너스", lv1: "+25.3%", lv2: "+27.6%", lv3: "+29.9%" },
    ],
  },
  "개척자 분석 장치": {
    baseStats: { 방어력: 21, 힘: 41 },
    uniqueStat: { name: "궁극기 피해 보너스", value: "+51.8%" },
    forge: [
      { name: "힘", lv1: 45, lv2: 49, lv3: 53 },
      { name: "궁극기 피해 보너스", lv1: "+56.9%", lv2: "+62.1%", lv3: "+67.3%" },
    ],
  },
  "개척자 산소 공급 장치": {
  ...
  "검술사 위치 신호기": {
    ...
    forge: [
      { name: "힘", lv1: 45, lv2: 49, lv3: 53 },
      { name: "오리지늄 아츠 강도", lv1: 46, lv2: 50, lv3: 54 },
    ],
  },
  "검술사 초소형 필터": {
  ...
  "본 크러셔 중갑 방어구 · II": {
    baseStats: { 방어력: 56, 민첩: 87, 힘: 58 },
    uniqueStat: { name: "냉기와 전기 피해 보너스", value: "+11.5%" },
    forge: [
      { name: "민첩", lv1: 95, lv2: 104, lv3: 113 },
      { name: "힘", lv1: 63, lv2: 69, lv3: 75 },
      { name: "냉기와 전기 피해 보너스", lv1: "+12.7%", lv2: "+13.8%", lv3: "+14.9%" },
    ],
  },
  ...
  "위기 탈출 장갑": {
    baseStats: { 방어력: 42, 힘: 86 },
    uniqueStat: { name: "모든 스킬 피해 보너스", value: "+24%" },
    forge: [
      { name: "힘", lv1: 94, lv2: 103, lv3: 111 },
      { name: "모든 스킬 피해 보너스", lv1: "+26.4%", lv2: "+28.8%", lv3: "+31.2%" },
    ],
  },
  "위기 탈출 보호 장갑": {
    baseStats: { 방어력: 42, 민첩: 86 },
    uniqueStat: { name: "궁극기 피해 보너스", value: "+45%" },
    forge: [
      { name: "민첩", lv1: 94, lv2: 103, lv3: 111 },
      { name: "궁극기 피해 보너스", lv1: "+49.5%", lv2: "+54%", lv3: "+58.5%" },
    ],
  },
  "위기 탈출 방어구": {
    baseStats: { 방어력: 56, 지능: 115 },
    uniqueStat: { name: "궁극기 충전 효율", value: "+12.9%" },
    forge: [
      { name: "지능", lv1: 126, lv2: 138, lv3: 149 },
      { name: "궁극기 충전 효율", lv1: "+14.1%", lv2: "+15.4%", lv3: "+16.7%" },
    ],
  },
  "위기 탈출 중장갑": {
    baseStats: { 방어력: 56, 민첩: 115 },
    uniqueStat: { name: "일반 공격 피해 보너스", value: "+14.4%" },
    forge: [
      { name: "민첩", lv1: 126, lv2: 138, lv3: 149 },
      { name: "일반 공격 피해 보너스", lv1: "+15.8%", lv2: "+17.3%", lv3: "+18.7%" },
    ],
  },
