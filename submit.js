...
const BOSS_LIST = [
  { group: '보스', items: ["로댄", "트리아겔로스", "마블 아겔로미레", "원일"] },
  { group: '그림자 이정표 — 대지에게 버림받은 존재', items: ["독 안개 탈출", "이단의 길", "활과 도끼의 연계"] },
  { group: '그림자 이정표 — 무기물', items: ["다가오는 위협", "돌격의 방패", "흔들림 없는 기반"] },
  { group: '그림자 이정표 — 작열의 흉터', items: ["원한의 장막", "혈육의 융해점", "포효의 화염"] },
];

const PARTY_LIST = [
  "레바테인","질베르타","이본","관리자","포그라니치니크","엠버","라스트 라이트","여풍","아델리아",
  "탕탕","로시","장방이","펠리카","진천우","울프가드","아크라이트","자이히","알레쉬","판","아비웨나","스노우샤인",
